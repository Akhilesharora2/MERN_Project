                    ...
                    <div className="col-md-4">
                        <div class="card p-3">                 
                            <div class="card-body text-center">
                                ...
                                <h5 class="card-title mb-3 fs-4 fw-bold">Super Easy</h5>
                    ...
                    <div className="col-md-4">
                        <div class="card p-3">                 
                            <div class="card-body text-center">
                                ...
                                <h5 class="card-title mb-3 fs-4 fw-bold">Phone accessible</h5>
                                <p class="card-text lead">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                    ...
                    <div className="col-md-4">
                        <div class="card p-3">                 
                            <div class="card-body text-center">
                                ...
                                <h5 class="card-title mb-3 fs-4 fw-bold">Creative way</h5>
                                <p class="card-text lead">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                    ...
                    <div className="col-md-4">
                        <div class="card p-3">                 
                            <div class="card-body text-center">
                                ...
                                <h5 class="card-title mb-3 fs-4 fw-bold">Unique & Clean</h5>
                                <p class="card-text lead">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                    ...
                    <div className="col-md-4">
                        <div class="card p-3">                 
                            <div class="card-body text-center">
                                ...
                                <h5 class="card-title mb-3 fs-4 fw-bold">Stay Updated</h5>
                                <p class="card-text lead">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
