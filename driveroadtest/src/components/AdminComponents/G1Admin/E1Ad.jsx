...
useEffect(() => {
  ...
  const handleChangeForNewStatement = (event) => {
    NS = document.getElementById("NS_E1").value;
    N1 = document.getElementById("N1_E1").value;
    N2 = document.getElementById("N2_E1").value;
    N3 = document.getElementById("N3_E1").value;
    N4 = document.getElementById("N4_E1").value;
    N5 = document.getElementById("N5_E1").value;
  ...
  const newStatement = (id) => {
    if (change) {
      ...
      setStmt(true);
      document.getElementById("NS_E1").value = '';
      document.getElementById("N1_E1").value = '';
      document.getElementById("N2_E1").value = '';
      document.getElementById("N3_E1").value = '';
      document.getElementById("N4_E1").value = '';
      document.getElementById("N5_E1").value = '';
  ...
  function toggleNewStatement() {
    var stmt = document.getElementById('NewStatementE1');
    if (stmt) {
  ...
  return (    
    ...
    <h6>Knowledge Test 1(P1Ad)</h6>
      ...
      <form onSubmit={() => newStatement(Response._id)} method="PUT" id='NewStatementE1' encType='multipart/form-data'>
        <h6>Add a new Statement: {newelement.length + 1}</h6>
        <h6 className='stmt'>Statement {newelement.length + 1}: <input type="text" onChange={handleChangeForNewStatement} id='NS_E1' name="NS" placeholder="Enter a new statement..." /> </h6>
        <h6 className='stmt'>Option 1: <input type="text" onChange={handleChangeForNewStatement} id="N1_E1" name="N1" placeholder='Option A' /> </h6>
        <h6 className='stmt'>Option 2: <input type="text" onChange={handleChangeForNewStatement} id="N2_E1" name="N2" placeholder='Option B' /> </h6>
        <h6 className='stmt'>Option 3: <input type="text" onChange={handleChangeForNewStatement} id="N3_E1" name="N3" placeholder='Option C' /> </h6>
        <h6 className='stmt'>Option 4: <input type="text" onChange={handleChangeForNewStatement} id="N4_E1" name="N4" placeholder='Option D' /> </h6>
        <select 
            ...
            {/* {
              (images.length) >= (key + 1) ?
                `/Exam1/${images[key].image}` !== '/Exam1/ ' ?
                  ...
                  <>
                    <img className='StmtImage' src={`/Exam1/${encodeURI(images[key].image)}`} alt={encodeURI(images[key].image)} />
                    <br></br>
