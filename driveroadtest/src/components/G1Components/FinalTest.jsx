...
const FinalTest = () => {
  ...
  return (
    <div>
      <h6 className='mb-5'>Finally before you go</h6>
        <div className="container">
          <div className="row">
            <h6 className='bg-warning'>The information given below is meant to be for Ontario, Canada.</h6>
            ...
            <ul>
              ...
              <li><i className='fa fa-arrow-right me-2'></i> Available in English or French, at a minimum. (Class G1 knowledge tests are offered in 28 languages.)</li>
              </ul>
            </div>
            <div className="row">
            <table>
        ...
        <div className='mt-5'>
            <small>This is not an officail version. <br />Posted on: September 26,2023 <br /> Source: https://drivetest.ca/tests/knowledge-tests/</small>
        </div>
    </div>
  )
}
